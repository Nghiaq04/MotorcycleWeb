    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                // Gửi mail thủ công qua SendGmail
                string subject = "Reset Password - Motorcycle Web";
                string body = $@"
<html>
<head>
    <style>
...
<body>
    <div class='container'>
        ...
        <p>Xin chào,</p>
        <p>Chúng tôi đã nhận được yêu cầu đặt lại mật khẩu cho tài khoản <strong>Motorcycle Shop</strong> của bạn.</p>
        <p>Nhấn nút bên dưới để tạo mật khẩu mới:</p>
        <div style='text-align:center;'>
            <a href='{callbackUrl}' class='btn'>Đặt lại mật khẩu</a>
        </div>
        <p>Nếu bạn không yêu cầu đặt lại mật khẩu, vui lòng bỏ qua email này. Tài khoản của bạn vẫn an toàn.</p>
        <div class='footer'>
            <p>© 2025 Motorcycle Shop. Bảo lưu mọi quyền.</p>
        </div>
    </div>
</body>
</html>";
                ...
                bool send = SendGmail.SendMail("Motorcycle Web", subject, body, model.Email);
